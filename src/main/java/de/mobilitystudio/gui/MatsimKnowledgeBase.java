...
final class MatsimKnowledgeBase {
    ...
    static final String DEFAULT_INSTRUCTIONS = 
            ...
            + "- **'Delete' button**: removes the previous run's output folder. Use this when MATSim aborts with 'output directory ... already exists'.\n"
            ...
            + "- **controller**: `outputDirectory`, `firstIteration`, `lastIteration`, `overwriteFiles` (values: failIfDirectoryExists, deleteDirectoryIfExists, overwriteExistingFiles). *Never use overwriteOutputDirectory*.\n"
